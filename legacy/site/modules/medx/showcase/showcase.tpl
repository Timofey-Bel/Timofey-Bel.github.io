...
<head>
    ...
    <link rel="stylesheet" href="/site/modules/medx/showcase/style_fixed.css">
...
<main>
    ~~*
    <div class="vector" src="/site/modules/medx/showcase/img/vector-8@4x.png"></div>
    <div class="img" src="/site/modules/medx/showcase/img/vector-16@4x.png"></div>
    <div class="vector-2" src="/site/modules/medx/showcase/img/vector-13@4x.png"></div>
    ...
    *~
    <section class="mainblock">
        ...
        <div class="textmain">
            <img class="logo-2" src="/site/modules/medx/showcase/img/logo-2@3x.png"/>
        ...
        ~~*
        <div class="doodles">
            <img class="group-2" src="/site/modules/medx/showcase/img/main-blood.png"/>
            <img class="group-3" src="/site/modules/medx/showcase/img/main-steth.png"/>
            <img class="group-4" src="/site/modules/medx/showcase/img/main-ritm.png"/>
            <img class="group-5" src="/site/modules/medx/showcase/img/main-list.png"/>
            <img class="group-6" src="/site/modules/medx/showcase/img/main-tube.png"/>
            <img class="vector-11" src="/site/modules/medx/showcase/img/vector-33@2x.png"/>
            <img class="vector-12" src="/site/modules/medx/showcase/img/main-pills.png"/>
            <img class="group-7" src="/site/modules/medx/showcase/img/main-bottle.png"/>
            <img class="vector-13" src="/site/modules/medx/showcase/img/main-tabls.png"/>
            <img class="vector-14" src="/site/modules/medx/showcase/img/main-plus.png"/>
            <img class="group-8" src="/site/modules/medx/showcase/img/main-syringe.png"/>
            <img class="doodles-img" src="/site/modules/medx/showcase/img/doodles.png"/>
        </div>
        *~
    </section>
    <section class="conveyor-container">
        <div class="conveyor-bar">
            ...
            <img class="vector-8" src="/site/modules/medx/showcase/img/vector-11.png"/>
            <p class="element">РЕГИСТРИРУЙСЯ СЕЙЧАС И ПОЛУЧИ ДОСТУП КО ВСЕМ МАТЕРИАЛАМ БЕСПЛАТНО НА 3 ДНЯ</p>
            <img class="vector-8" src="/site/modules/medx/showcase/img/vector-11.png"/>
    ...
    <section class="block-disciplines">
        ...
        <div class="view-3">
            ...
            <div class="btns">
                <div class="frame-21">
                    <div class="view-4">
                        <img class="img-2" src="/site/modules/medx/showcase/img/ecg-1@2x.png"/>
                        <div class="text-wrapper-25">Патологическая физиология</div>
                    </div>
                    <div class="view-4">
                        <img class="img-2" src="/site/modules/medx/showcase/img/pill-1@2x.png"/>
                        <div class="text-wrapper-25">Фармакология</div>
                    </div>
                    <div class="view-4">
                        <img class="img-2" src="/site/modules/medx/showcase/img/amoeba-1@2x.png"/>
                        <div class="text-wrapper-25">Медицинская биология</div>
                    </div>
                </div>
                <div class="frame-22">
                    <div class="view-4">
                        <img class="img-2" src="/site/modules/medx/showcase/img/dna-2@2x.png"/>
                        <div class="text-wrapper-25">Медицинская генетика</div>
                    </div>
                    <div class="view-4">
                        <img class="img-2" src="/site/modules/medx/showcase/img/ultrasound-1@2x.png"/>
                        <div class="text-wrapper-25">Медицинская физика</div>
                    </div>
                </div>
                <div class="view-5">
                    <img class="img-2" src="/site/modules/medx/showcase/img/muscle-cell-1@2x.png"/>
                    <div class="text-wrapper-25">Гистология</div>
                </div>
                <div class="view-6">
                    <img class="img-2" src="/site/modules/medx/showcase/img/embryo-1@2x.png"/>
                    <div class="text-wrapper-25">Эмбриология</div>
                </div>
                <div class="view-7">
                    <img class="img-2" src="/site/modules/medx/showcase/img/follicle-1@2x.png"/>
                    <div class="text-wrapper-25">Цитология</div>
                </div>
                <div class="view-8">
                    <img class="img-2" src="/site/modules/medx/showcase/img/red-blood-cells-1@2x.png"/>
                    <div class="text-wrapper-25">Физиология</div>
                </div>
                <div class="view-9">
                    <img class="img-2" src="/site/modules/medx/showcase/img/biochemistry@2x.png"/>
                    <div class="text-wrapper-25">Биохимия</div>
                </div>
                <div class="view-10">
                    <img class="img-2" src="/site/modules/medx/showcase/img/microbiology-1@2x.png"/>
                    <div class="text-wrapper-25">Микробиология</div>
                </div>
                <div class="view-11">
                    <img class="cell" src="/site/modules/medx/showcase/img/cell-1@2x.png"/>
                    <div class="text-wrapper-25">Иммунология</div>
                </div>
                <div class="view-12">
                    <img class="img-2" src="/site/modules/medx/showcase/img/biopsy-1@2x.png"/>
                    <div class="text-wrapper-25">Патологическая анатомия</div>
                </div>
                <div class="view-13">
                    <img class="img-2" src="/site/modules/medx/showcase/img/human-organs-1@2x.png"/>
        ...
        <div class="group">
            ...
            <div class="btns-2">
                <div class="frame-23">
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/heart-3-1@2x.png"/>
                        <div class="text-wrapper-25">Кардиология</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/lungs-2@2x.png"/>
                        <div class="text-wrapper-25">Пульмонология</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/stomach-2@2x.png"/>
                        <div class="text-wrapper-25">Гастроэнтерология</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/thyroid-2@2x.png"/>
                        <div class="text-wrapper-25">Эндокринология</div>
                    </div>
                </div>
                <div class="frame-24">
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/kidneys@2x.png"/>
                        <div class="text-wrapper-25">Нефрология</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/blood-vessel-1@2x.png"/>
                        <div class="text-wrapper-25">Гематология</div>
                    </div>
                    <div class="view-15">
                        <img class="joint" src="/site/modules/medx/showcase/img/joint-1@2x.png"/>
                        <div class="text-wrapper-27">Ревматология</div>
                    </div>
                    <div class="view-16">
                        <img class="img-2" src="/site/modules/medx/showcase/img/bacterias-1@2x.png"/>
                        <div class="text-wrapper-25">Инфекционные болезни</div>
                    </div>
                </div>
                <div class="frame-25">
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/surgery-1@2x.png"/>
                        <div class="text-wrapper-25">Общая хирургия</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/eye@2x.png"/>
                        <div class="text-wrapper-25">Офтальмология</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/ear-6326320@2x.png"/>
                        <div class="text-wrapper-25">Оториноларингология</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/bladder-2@2x.png"/>
                        <div class="text-wrapper-25">Урология</div>
                    </div>
                </div>
                <div class="frame-26">
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/surgery-2@2x.png"/>
                        <div class="text-wrapper-25">Сердечно-сосудистая хирургия</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/neurosurgery-2-1@2x.png"/>
                        <div class="text-wrapper-25">Нейрохирургия</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/uterus@2x.png"/>
                        <div class="text-wrapper-25">Акушерство и гинекология</div>
                    </div>
                </div>
                <div class="frame-27">
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/electrocardiogram-1@2x.png"/>
                        <div class="text-wrapper-25">Анестезиология и реаниматология</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/spine-1@2x.png"/>
                        <div class="text-wrapper-25">Травматология и ортопедия</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/cancer-cell-1@2x.png"/>
                        <div class="text-wrapper-25">Онкология</div>
                    </div>
                </div>
                <div class="frame-28">
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/rib-cage-1@2x.png"/>
                        <div class="text-wrapper-25">Торакальная хирургия</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/hair@2x.png"/>
                        <div class="text-wrapper-25">Дерматовенерология</div>
                    </div>
                    <div class="view-14">
                        <img class="img-2" src="/site/modules/medx/showcase/img/baby-1@2x.png"/>
                        <div class="text-wrapper-25">Педиатрия</div>
                    </div>
                </div>
                <div class="frame-29">
                    <div class="view-17">
                        <img class="img-3" src="/site/modules/medx/showcase/img/neuron-1@2x.png"/>
                        <div class="text-wrapper-28">Неврология</div>
                    </div>
                    <div class="view-17">
                        <img class="img-3" src="/site/modules/medx/showcase/img/psychologist-1@2x.png"/>
    ...
    <section class="block">
        <div class="card">
            <img class="vector-5" src="/site/modules/medx/showcase/img/vector-17.png"/>
            <div class="text-card">
        ...
        <div class="card-2">
            ...
            <img class="vector-6" src="/site/modules/medx/showcase/img/vector-18@4x.png"/>
        ...
        <div class="card-3">
            <img class="vector-7" src="/site/modules/medx/showcase/img/vector-19.png"/>
            <div class="video-card"></div>
    ...
    <section class="under">
        ...
        <img class="free-mobile-friendly" src="/site/modules/medx/showcase/img/devices.png"/>
    </section>
</main>

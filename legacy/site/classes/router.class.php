...
//                case 'where':         print ($_SESSION['smarty']->fetch('str:'.$rout.'/where'));                  break;
                ...
                case 'faq':         print ($_SESSION['smarty']->fetch('str:'.$rout.'/faq'));                      break;


                case 'main_showcase':         print ($_SESSION['smarty']->fetch('str:'.$rout.'/main_showcase'));                break;
                case 'main_settings':         print ($_SESSION['smarty']->fetch('str:'.$rout.'/main_settings'));                break;
                case 'design_settings':       print ($_SESSION['smarty']->fetch('str:'.$rout.'/design_settings'));              break;
                case 'support_settings':      print ($_SESSION['smarty']->fetch('str:'.$rout.'/support_settings'));             break;
                case 'main_tests':            print ($_SESSION['smarty']->fetch('str:'.$rout.'/main_tests'));                   break;
                case 'main_community':        print ($_SESSION['smarty']->fetch('str:'.$rout.'/main_community'));               break;




                case 'sms':
                    include_once 'site/modules/medx/sms/sms.class.php';
                    $m = new sms();

...
Интерактивная образовательная платформа для студентов медицинских вузов с базой знаний, тестами и сообществом. Ссылка на сайт: https://timofey-bel.github.io/

...
<head>
    ...
    <link rel="stylesheet" href="/assets/medx/css/profile.css">
</head>
<body>
                        ...
                        <form id="personal-form" class="profile-form">
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="firstName" name="first_name" value="~~$user.first_name~" placeholder="Имя">
                                </div>
                                <div class="form-group">
                                    <label for="lastName">Фамилия</label>
                                    <input type="text" id="lastName" name="last_name" value="~~$user.last_name~" placeholder="Фамилия">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="middleName">Отчество</label>
                                <input type="text" id="middleName" name="middle_name" value="~~$user.middle_name~" placeholder="Отчество">
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="birthDate">Дата рождения</label>
                                    <input type="date" id="birthDate" name="birth_date" value="~~$user.birth_date~">
                                </div>
                                <div class="form-group">
                                    <label for="gender">Пол</label>
                                    <select id="gender" name="gender">
                                        <option value="">Выберите пол</option>
                                        <option value="male"~~if $user.gender == 'male'~ selected~~/if~>Мужской</option>
                                        <option value="female"~~if $user.gender == 'female'~ selected~~/if~>Женский</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="profile-section">
                      ...
                      Подтвержден
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-badge">
                                    <input type="tel" id="phone" name="phone" value="~~$user.phone~" placeholder="+7 (999) 999-99-99">
                                    <span class="verified-badge">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M5 8l2 2 4-4" stroke="white" stroke-width="2"/>
                      </svg>
                ...
                <section class="tab-content" id="addresses">
                    ...
                    <div class="addresses-grid">
                        <div class="address-card">
                            ...
                            <h3><input type="text" id="city" name="city" value="~~$user.city~" placeholder="Город"></h3>
                            <p>улица Пушкина, д. 15, кв. 42</p>
                            <p class="address-contact"><input type="text" id="address" name="address" value="~~$user.address~" placeholder="Улица, дом, квартира"></p>
...
<script src="/assets/medx/js/profile.js"></script>
</body>
</html>
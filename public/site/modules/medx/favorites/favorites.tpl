...
<head>
    ...
    <link rel="stylesheet" href="/assets/medx/css/favorites.css">
    ~~include file="medx/tpl/scripts.tpl"~
</head>
<body>
...
<script src="/assets/medx/js/favorites-viewmodel.js"></script>
<script src="/assets/medx/js/favorites.js"></script>
